...
@section('content')
    <div class="col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3" style="margin-top:60px;">
        <div class="thumbnail" >
            <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12 col-lg-offset-3 col-md-offset-3">
                                <div style="color:#9aa4af; max-height:550px; overflow: auto;">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-sm-3 control-label" for="tel">Phone</label>
                                        <div class="col-md-9 col-sm-9">
                                            <p class="profile">{{$user->tel}}</p>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 col-sm-3 control-label" for="location">Location</label>
                                        <div class="col-md-9 col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 col-sm-3 control-label" for="sex">Gender</label>
                                        <div class="col-md-9 col-sm-9">
