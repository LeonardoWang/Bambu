...
var Intense = (function() {
    ...
    function getFit( source, container ) {
      ...
      var heightRatio = window.innerHeight / source.h * 1.25;

      if( (source.w * heightRatio) > window.innerWidth *0.75) {
        return { w: source.w * heightRatio, h: source.h * heightRatio, fit: true };
      } else {
        var widthRatio = window.innerWidth / source.w *0.4;
